...
public enum ResultCode implements IResultCode {
	 ...
	 * 无 TOKEN，请先登录
	 */
	TOKEN_NULL_ERROR(20001, "无 TOKEN，请先登录"),
	/**
	 * TOKEN 解析失败
	 */
	TOKEN_PARSE_ERROR(20002, "TOKEN 解析失败"),
	/**
	 * TOKEN 验证失败
	 */
	TOKEN_VERIFY_ERROR(20003, "TOKEN 验证失败"),
	/**
	 * TOKEN 已被更新，该账号已在其他设备登录
	 */
	TOKEN_UPDATED_ERROR(20004, "TOKEN 已被更新，该账号已在其他设备登录"),
	/**
	 * TOKEN 失效，请重新登录
	 */
	TOKEN_EXPIRE_ERROR(20005, "TOKEN 失效，请重新登录"),

	/**
	 * 无 TOKEN 或 TOKEN 失效，请先登录
	 */
	TOKEN_NULL_EXPIRE_ERROR(20006, "无 TOKEN 或 TOKEN 失效，请先登录");
	/**
	 * 状态码
	 */
	final int code;
